...
final class HotKeysController {
	...
	static nonisolated(unsafe) var hotKeys = [UInt32: HotKeyBox]()
	static nonisolated(unsafe) private var hotKeysCount: UInt32 = 0
	...
	private static nonisolated(unsafe) var eventHandler: EventHandlerRef?
